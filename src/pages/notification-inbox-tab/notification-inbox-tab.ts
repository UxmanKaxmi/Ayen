...
/**
 * Generated class for the NotificationInboxTabPage page.
 *
...
@Component({
  selector: 'page-notification-inbox-tab',
  templateUrl: 'notification-inbox-tab.html',
})
export class NotificationInboxTabPage {
...
},
{
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad NotificationInboxTabPage');
  }
